      ...
      getActivityDetail(id)
        .then(res => {
          if (res.code === 1) {
            ...
            console.log('接收到的活动数据:', activity);
            console.log('活动ID类型:', typeof activity.id, '值:', activity.id);
            form.setFieldsValue({
      ...
      >
        ...
        <Form.Item label="活动坐标">
          <Input.Group compact>
            ...
            >
              <InputNumber placeholder="纬度" style={{ width: '40%' }} min={-90} max={90} step={0.000001} />
            </Form.Item>
            <Form.Item
              name="longitude"
              noStyle
            ...
            >
              <InputNumber placeholder="经度" style={{ width: '40%' }} min={-180} max={180} step={0.000001} />
                        </Form.Item>
            <Button onClick={handleGetLocation} style={{ width: '20%' }}>
              获取当前位置
            </Button>
          </Input.Group>
        </Form.Item>
